...
if __name__ == '__main__':
    ...
    '''
    acc = 0
    with open("mi_tagged_" + short_model_name+"_s-"+str(number_of_samples)+"_t-"+str(temperature)+"_acc-"+str(acc)+".txt", 'w', encoding='utf8') as f_out:
        f_out.write(out_str)

    mi_dataset.print_to_file("mi_tagged_" + short_model_name+".csv")